...
wrappers = [
    ...
    supersuit.normalize_obs_v0(
        dtype_v0(generated_agents_env_v0.env(), np.float32), env_min=-1, env_max=5.0
    ),
...
parallel_wrappers = wrappers = [
    ...
    supersuit.normalize_obs_v0(
        dtype_v0(generated_agents_parallel_v0.parallel_env(), np.float32),
        env_min=-1,
        env_max=5.0,
    ),
    supersuit.frame_stack_v1(generated_agents_parallel_v0.parallel_env(), 8),
    supersuit.reward_lambda_v0(
        generated_agents_parallel_v0.parallel_env(), lambda x: x / 10
    ),
...
wrapper_fns = [
    ...
    lambda: supersuit.pettingzoo_env_to_vec_env_v1(
