...
from pettingzoo.butterfly import knights_archers_zombies_v10, prison_v4
...
wrappers = [
    ...
    supersuit.reward_lambda_v0(
        knights_archers_zombies_v10.env(), lambda x: x / 10),
...
parallel_wrappers = [
    ...
    supersuit.reward_lambda_v0(
        combined_arms_v5.parallel_env(), lambda x: x / 10),
