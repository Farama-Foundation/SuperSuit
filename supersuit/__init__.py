...
cyclically_expansive_learning_v0 = Depreciated("cyclically_expansive_learning", "v0", "v1")
cyclically_expansive_learning_v1 = WrapperFactory("cyclically_expansive_learning")
